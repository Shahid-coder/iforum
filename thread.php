...
<body>
    ...
    <div class="container my-4">
        <div class="jumbotron">
            ...
            <h4>Forum rules</h4>
            <p>
                <li>This is a peer to peer forum is for sharing knoledge with each other.</li>
    ...
    <form action="'.$_SERVER['REQUEST_URI'].'" method="post">
        <div class="form-group">
            <label for="exampleFormControlTextarea1">type your coment</label>
    ...
    while($row=mysqli_fetch_assoc($result)){
        ...
        $row2=mysqli_fetch_assoc($result2);
            ...
            <img src="img/defaultuser.jpg" width="54px" class="mr-3" alt="...">
        ...
        if($noResult){
            ...
            <div class="container">
              ...
              <h1 class="lead">Be the first person to comment</h1>
            </div>
          </div>';
        }
    ?>
